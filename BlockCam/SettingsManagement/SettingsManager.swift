...
class Settings
{
    ...
    public static func AddDefaultSettings()
    {
        ...
        UserDefaults.standard.set("Brightness", forKey: SettingKeys.HeightSource.rawValue)
        UserDefaults.standard.set("Medium", forKey: SettingKeys.ImageSizeConstraints.rawValue)
        UserDefaults.standard.set("Medium", forKey: SettingKeys.VerticalExaggeration.rawValue)
        ...
        UserDefaults.standard.set("Smooth", forKey: SettingKeys.LetterSmoothness.rawValue)
