...
//  BlockCam
//
//  Created by Stuart Rankin on 12/18/19.
...
class StarOptionsCode: UITableViewController
{
    ...
    func UpdateSample(WithIntensity: Float)
    {
        ...
        if Settings.GetBoolean(ForKey: .IncreaseStarApexesWithProminence)
        {
            ...
            IntensityLabel.text = Utilities.RoundedString(Value: Double(WithIntensity), Precision: 3)
        }
