...
public class Versioning: CustomStringConvertible
{
    ...
    public static let MinorVersion: String = "8"
    ...
    /// Build number.
    public static let Build: Int = 1548
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "F96BFAD4-8C1E-453C-AA2E-AF79E5CF632A"
    
    /// Build date.
    public static let BuildDate: String = "27 January 2020"
    
    /// Build Time.
    public static let BuildTime: String = "22:26"
